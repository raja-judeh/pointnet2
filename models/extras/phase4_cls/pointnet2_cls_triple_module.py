...
import numpy as np
import tf_util
from pointnet_util import pointnet_triple_module, pointnet_sa_module, pointnet_sa_module_msg
...
def get_model(point_cloud, is_training, bn_decay=None):
    ...
    _, tl0_points = pointnet_triple_module(l0_xyz, l0_points, [32,32], is_training, bn_decay, scope='tlayer1', knn=k)
    ...
    _, tl1_points = pointnet_triple_module(l1_xyz, l1_points, [64,64], is_training, bn_decay, scope='tlayer2', knn=k)
    ...
    _, tl2_points = pointnet_triple_module(l2_xyz, l2_points, [128,128], is_training, bn_decay, scope='tlayer3', knn=k)
