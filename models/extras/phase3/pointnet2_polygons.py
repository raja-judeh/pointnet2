...
import numpy as np
import tf_util
from pointnet_util import pointnet_sa_module, pointnet_sa_module_msg, pointnet_fp_module, pointnet_polygon_module
...
def get_model(point_cloud, cls_label, is_training, bn_decay=None):
    ...
    _, tl0_points = pointnet_polygon_module(l0_xyz, l0_points, [32,32,64], is_training, bn_decay, scope='tlayer1')
    ...
    _, tl1_points = pointnet_polygon_module(l1_xyz, l1_points, [64,64,128], is_training, bn_decay, scope='tlayer2')
    ...
    _, tl2_points = pointnet_polygon_module(l2_xyz, l2_points, [128,128,256], is_training, bn_decay, scope='tlayer3')
