...
import numpy as np
import tf_util
from pointnet_util import pointnet_sa_module, pointnet_sa_module_rand_triples, pointnet_fp_module
...
def get_model(point_cloud, cls_label, is_training, bn_decay=None):
    ...
    l1_xyz, l1_points, l1_indices = pointnet_sa_module_rand_triples(l0_xyz, l0_points, npoint=512, radius=0.4, nsample=64, mlp=[64,64,128], mlp2=None, group_all=False, is_training=is_training, bn_decay=bn_decay, scope='layer1', nshuffles=2)
    l2_xyz, l2_points, l2_indices = pointnet_sa_module_rand_triples(l1_xyz, l1_points, npoint=128, radius=0.8, nsample=64, mlp=[128,128,256], mlp2=None, group_all=False, is_training=is_training, bn_decay=bn_decay, scope='layer2', nshuffles=2)
