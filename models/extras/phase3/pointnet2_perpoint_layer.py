...
import numpy as np
import tf_util
from pointnet_util import pointnet_sa_module, pointnet_sa_module_msg, pointnet_fp_module, pointnet_perpoint_module
...
def get_model(point_cloud, cls_label, is_training, bn_decay=None):
    ...
    # Per-point layer 
    lpp_points = pointnet_perpoint_module(point_cloud, [64,128,128], is_training, bn_decay=bn_decay)
    ...
    l0_points = pointnet_fp_module(l0_xyz, l1_xyz, tf.concat([cls_label_one_hot, l0_xyz, l0_points, lpp_points],axis=-1), l1_points, [128,128], is_training, bn_decay, scope='fp_layer3')
