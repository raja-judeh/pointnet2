...
def get_model(point_cloud, cls_label, pp_idx, is_training, bn_decay=None):
    ...
    _, l30_points, _ = pointnet_sa_module(l0_xyz, l0_points, npoint=None, radius=None, nsample=None, mlp=[64,128,256,512,1024], mlp2=None, group_all=True, is_training=is_training, bn_decay=bn_decay, scope='layer30')

    #l3_points = tf.concat([l32_points,l31_points,l30_points], axis=-1)
    #l3_points = tf.add_n([l32_points,l31_points,l30_points]
