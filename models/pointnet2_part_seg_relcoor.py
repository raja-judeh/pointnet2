...
from pointnet_util import pointnet_sa_module, pointnet_fp_module, sample_and_group
...
def get_model(point_cloud, is_training, bn_decay=None):
    ...
    l0_points = pointnet_fp_module(l0_xyz, l1_xyz, tf.concat([l0_xyz_rel,l0_points],axis=-1), l1_points, [128,128,128], is_training, bn_decay, scope='fa_layer3')
