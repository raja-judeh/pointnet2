...
import numpy as np
import tf_util
from multipoints_util import pointnet_sa_module, pointnet_sa_module_msg, pointnet_fp_module
...
def get_model(point_cloud, cls_label,  pp_idx, is_training, bn_decay=None):
    ...
    l1_xyz, l1_points = pointnet_sa_module_msg(l0_xyz, orig_points, 512, [0.1,0.2,0.4], [32,64,128], [[32,32,64], [64,64,128], [64,96,128]], is_training, bn_decay, scope='layer1')
  ...
  # Feature propagation layers (feature propagation after each SA layer)
    ...
    l0_points = pointnet_fp_module(l0_xyz, l1_xyz, tf.concat([cls_label_one_hot, l0_xyz, orig_points],axis=-1), l1_points, [128,128], is_training, bn_decay, scope='fp_layer3')
