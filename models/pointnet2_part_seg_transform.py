...
def get_model(point_cloud, is_training, bn_decay=None):
    ...
    l1_xyz, l1_points, l1_indices = pointnet_sa_module(l0_xyz_transformed, l0_points_transformed, npoint=512, radius=0.2, nsample=64, mlp=[64,64,128], mlp2=None, group_all=False, is_training=is_training, bn_decay=bn_decay, scope='layer1')
    ...
    l0_points = pointnet_fp_module(l0_xyz_transformed, l1_xyz, tf.concat([l0_xyz_transformed,l0_points_transformed],axis=-1), l1_points, [128,128,128], is_training, bn_decay, scope='fa_layer3')
