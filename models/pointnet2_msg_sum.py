...
import numpy as np
import tf_util
from pointnet_util import pointnet_sa_module, pointnet_sa_module_msg_sum, pointnet_fp_module
...
def get_model(point_cloud, cls_label, is_training, bn_decay=None):
    ...
    l1_xyz, l1_points = pointnet_sa_module_msg_sum(l0_xyz, l0_points, 512, [0.1,0.2], [32,64], [[32,32,64,128], [64,64,128]], is_training, bn_decay, scope='layer1')
    l2_xyz, l2_points = pointnet_sa_module_msg_sum(l1_xyz, l1_points, 128, [0.4,0.8], [32,64], [[128,128,256],[128,128,256]], is_training, bn_decay, scope='layer2')
