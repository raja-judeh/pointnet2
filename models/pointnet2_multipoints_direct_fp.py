...
def get_model(point_cloud, cls_label, pp_idx, is_training, bn_decay=None):
    ...
    fp2_points = pointnet_fp_module(l0_xyz, l3_xyz, tf.concat([cls_label_one_hot, l0_xyz, l0_points],axis=-1), l3_points, [256,256], is_training, bn_decay, scope='dfp_layer1')
    fp1_points = pointnet_fp_module(l0_xyz, l2_xyz, tf.concat([cls_label_one_hot, l0_xyz, l0_points],axis=-1), l2_points, [256,128], is_training, bn_decay, scope='dfp_layer2')
    fp0_points = pointnet_fp_module(l0_xyz, l1_xyz, tf.concat([cls_label_one_hot, l0_xyz, l0_points],axis=-1), l1_points, [128,128], is_training, bn_decay, scope='dfp_layer3')
    ...
    l0_points = tf.concat([fp2_points, fp1_points, fp0_points, l0_points], axis=-1)
