...
import numpy as np
import tf_util
from multipoints_util import pointnet_sa_module, pointnet_sa_module_cp, pointnet_fp_module
...
def get_model(point_cloud, cls_label, pp_idx, is_training, bn_decay=None):
    ...
    l1_xyz, l1_points, _ = pointnet_sa_module_cp(l0_xyz, orig_points, npoint=512, radius=0.2, nsample=64, mlp=[64,64,128], mlp2=None, group_all=False, is_training=is_training, bn_decay=bn_decay, scope='layer1')
    l2_xyz, l2_points, _ = pointnet_sa_module_cp(l1_xyz, l1_points, npoint=128, radius=0.4, nsample=64, mlp=[128,128,256], mlp2=None, group_all=False, is_training=is_training, bn_decay=bn_decay, scope='layer2')
