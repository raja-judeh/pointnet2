...
DATA_DIR = '/net/rmc-lx0185/home_local/master_thesis/pointnet2/data/'
...
parser.add_argument('--num_batches_train', type=int, help='Number of batches to use in the train set')
parser.add_argument('--num_batches_test', type=int, help='Number of batches to use in the test set')
...
NUM_BATCHES_TRAIN = FLAGS.num_batches_train
NUM_BATCHES_TEST = FLAGS.num_batches_test
...
TRAIN_DATASET = part_dataset_all_normal_rotated.PartNormalDataset(root=DATA_PATH, npoints=NUM_POINT, classification=False, split='train')
