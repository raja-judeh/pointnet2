...
import provider
import tf_util
import part_dataset_all_normal_one_category

parser = argparse.ArgumentParser()
parser.add_argument('--gpu', type=int, default=0, help='GPU to use [default: GPU 0]')
parser.add_argument('--input_cat', default='Airplane', help='Train only on the chosen category')
...
TRAIN_DATASET = part_dataset_all_normal_one_category.PartNormalDataset(root=DATA_PATH, input_cat=INPUT_CAT, npoints=NUM_POINT, classification=False, split='trainval')
TEST_DATASET = part_dataset_all_normal_one_category.PartNormalDataset(root=DATA_PATH, input_cat=INPUT_CAT, npoints=NUM_POINT, classification=False, split='test')
