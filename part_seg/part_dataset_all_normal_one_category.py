...
class PartNormalDataset():
    def __init__(self, root, input_cat, npoints = 2500, classification = False, split='train', normalize=True, return_cls_label = False):
...
if __name__ == '__main__':
    ...
    d = PartNormalDataset(root=DATA_PATH, input_cat='Airplane', split='trainval', npoints=3000)
    print((len(d)))
